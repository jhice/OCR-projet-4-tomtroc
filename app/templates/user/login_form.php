        ...
        <div class="flex items-center justify-center px-6 py-12 lg:px-20">
            <div class="w-full max-w-md">
                ...
                <form action="/?action=connect" method="post" class="space-y-8" novalidate>
                    ...
                    <button type="submit" class="w-full h-14 rounded-xl bg-[#00AC66] hover:bg-[#00985B] text-white font-semibold transition mt-4">Se connecter</button>
                </form>
                <p class="mt-8 text-sm text-[#555]">Pas de compte ? <a href="/?action=register" class="underline">Inscrivez-vous</a></p>
            </div>
        </div>
        <!-- IMAGE -->
